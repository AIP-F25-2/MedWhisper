  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm overflow-y-auto py-4">
      <div className="relative bg-white rounded-2xl shadow-2xl w-full max-w-md mx-4 overflow-hidden my-4">
        ...
        {/* Header */}
        <div className="bg-gradient-to-r from-[#014A93] to-[#2B6FDF] text-white p-8 pb-6">
          <div className="w-16 h-16 bg-white rounded-full flex items-center justify-center mx-auto mb-4">
            <svg className="w-10 h-10 text-[#014A93]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M18 9v3m0 0v3m0-3h3m-3 0h-3m-2-5a4 4 0 11-8 0 4 4 0 018 0zM3 20a6 6 0 0112 0v1H3v-1z" />
            </svg>
          </div>
          <h2 className="text-2xl font-bold text-center">Create Account</h2>
          <p className="text-white/80 text-center text-sm mt-2">Join MedWhisper today</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="p-8 pt-6">
          ...
          <div className="mb-6">
            <label className="flex items-start">
              <input
                ...
                className="w-4 h-4 mt-0.5 text-[#014A93] border-gray-300 rounded focus:ring-[#014A93]"
              />
              <span className="ml-2 text-sm text-gray-600">
                I agree to the{' '}
                <a href="#terms" className="text-[#014A93] hover:text-[#2B6FDF] font-medium">
                  Terms and Conditions
                </a>{' '}
                and{' '}
                <a href="#privacy" className="text-[#014A93] hover:text-[#2B6FDF] font-medium">
                  Privacy Policy
                </a>
              </span>
            </label>
          ...
          <p className="mt-6 text-center text-sm text-gray-600">
            ...
            <button 
              ...
              className="text-[#014A93] hover:text-[#2B6FDF] font-semibold"
            >
              Sign in
            </button>
          </p>
