    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm">
      <div className="relative bg-white rounded-2xl shadow-2xl w-full max-w-md mx-4 overflow-hidden">
        ...
        <div className="bg-gradient-to-r from-[#014A93] to-[#2B6FDF] text-white p-8 pb-6">
          ...
          <p className="text-white/80 text-center text-sm mt-2">Sign in to continue to MedWhisper</p>
        </div>
          ...
          <div className="flex items-center justify-between mb-6">
            <label className="flex items-center">
              <input
                ...
                className="w-4 h-4 text-[#014A93] border-gray-300 rounded focus:ring-[#014A93]"
              />
              <span className="ml-2 text-sm text-gray-600">Remember me</span>
            </label>
            <a href="#forgot-password" className="text-sm text-[#014A93] hover:text-[#2B6FDF] font-medium">
              Forgot password?
            </a>
          </div>
